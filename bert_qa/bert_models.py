...
from . import weighted_sparse_categorical_crossentropy
from . transformer_encoder import TransformerEncoder
from . albert_transformer_encoder import AlbertTransformerEncoder
from . import bert_classifier
from . import bert_pretrainer
from . import bert_span_labeler
...
class BertPretrainLossAndMetricLayer(tf.keras.layers.Layer):
  ...
  def call(self, inputs):
    ...
    mask_label_loss = weighted_sparse_categorical_crossentropy.loss(
        labels=lm_label_ids, predictions=lm_output, weights=lm_label_weights)
    sentence_loss = weighted_sparse_categorical_crossentropy.loss(
...
def get_transformer_encoder(bert_config,
  ...
  if isinstance(bert_config, bert_modeling.AlbertConfig):
    ...
    return AlbertTransformerEncoder(**kwargs)
  else:
